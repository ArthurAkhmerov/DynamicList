...
},{"jquery":2,"whatwg-fetch":176}],178:[function(require,module,exports){
...
},{"./rows/dynamicList":184}],179:[function(require,module,exports){
var React = require('react');
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function() {
    ...
    return React.createElement("span", {className: "dropdown"}, 
...
},{"./button":179,"./list-item":181,"react":175}],181:[function(require,module,exports){
var React = require('react');
...
var AddRowForm = React.createClass({displayName: "AddRowForm",
    getInitialState: function() {
        return {
            columns: [
      ...
      var tmpColumns = this.state.columns.map(function(column){
          return (
            React.createElement("div", null, 
              React.createElement(Cell, {editable: true, value: column.defaultValue, type: column.type, index: column.number, updateCell: component.HandleCellUpdated}), 
              React.createElement(DDL, {title: "Choose type", items: ["int", "double", "string"], changeColumnType: component.HandleCellUpdated2, number: column.number})
              )
              )
      })
    return (
        React.createElement("div", null, 
        React.createElement("button", {className: "btn btn-default", onClick: this.handleAddColumnClick}, "Add Column"), 
        React.createElement("button", {className: "btn btn-primary", onClick: this.handleRemoveColumnClick}, "Remove Column"), 
      React.createElement("form", {onSubmit: this.handleSubmit}, 
        
        tmpColumns, 
          
        React.createElement("button", {className: "btn btn-primary"}, "Add Row")
      )
        )
    );
  }
...
},{"../common/dropdown":180,"./cell":183,"jquery":2,"react":175}],183:[function(require,module,exports){
var React = require('react');
...
var Cell = React.createClass({displayName: "Cell",
    ...
    render: function() {
        ...
        if (this.props.editable){
            return React.createElement("td", null, React.createElement("input", {type: "text", value: component.state.value, onChange: component.handleValueChange}), " ", React.createElement("span", {style: errorStyle}, component.state.error, " ")
                    )
        } else {
            return React.createElement("td", null, component.state.value, " (", component.state.type, ")")                     
        }  
    }
});
...
var DynamicList = React.createClass({displayName: "DynamicList",
            getInitialState: function () {
                return {
                    rowNumbers: [],
                    cards: [],
            ...
            render: function () {
                ...
                var cards = this.state.rowNumbers.map(function (row) {
                        return ( React.createElement(Row, {key: row, number: row, 
                            editable: false, 
                    ...
                    return ( React.createElement("div", null, React.createElement(AddRowForm, {addRow: this.addRow}), 
                            React.createElement("hr", null), 
                            React.createElement("table", {className: "table"}, 
                                React.createElement("tbody", null, cards)
                            )
                            )
                    )
                }
...
},{"../../api/rowApi":177,"../common/dropdown":180,"./addRowForm":182,"./row":185,"jquery":2,"react":175,"react/addons":3}],185:[function(require,module,exports){
var React = require('react');
var Cell = require('./cell');
$ = jQuery = require('jquery');
var RowsApi = require('../../api/rowApi');
  ...
  componentDidMount: function() {
    ...
    HandleCellUpdated: function(index, value){
        ...
        changeButton: function() {
          ...
          return  React.createElement("button", {className: "btn btn-success", onClick: component.handleSaveClick}, "Save")
            }
      },
        editText: function() {
            var component = this;
  ...
  render: function() {
       ...
       var columns = this.state.cells.map(function(cell) {
        var isEditable = component.state.editable;
           ...
           return React.createElement(Cell, {editable: isEditable, value: cell.value, type: cell.type, index: cell.index, updateCell: component.HandleCellUpdated})
...
module.exports = Row;
},{"../../api/rowApi":177,"./cell":183,"jquery":2,"react":175}],186:[function(require,module,exports){
"use strict";
...
},{"./components/app":178,"react":175}]},{},[186]);
